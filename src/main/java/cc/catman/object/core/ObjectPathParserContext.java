...
public interface ObjectPathParserContext {
    ...
    default ObjectPathParserContext copyContext(){
        return copyContext(this);
    }
   default ObjectPathParserContext copyContext(ObjectPathParserContext context){
        return createContext(context.rootValue(),context.parentValue(),context.currentValue());
   }
    /**
     * 创建子上下文
     * @param current 当前对象
