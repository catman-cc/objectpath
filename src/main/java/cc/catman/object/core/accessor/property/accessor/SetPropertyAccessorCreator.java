 ...
 * @since 0.0.3
 */
public class SetPropertyAccessorCreator extends AbstractPropertyAccessorCreator{
    ...
    public int score(Class<?> type, Object indexOrName) {
        ...
        if (ReflectionHelper.isAssignableFrom(Set.class,type)){
            return 5;
        }
        return 0;
    }
    ...
    public PropertyAccessor create(Class<?> type, Object indexOrKeyName) {
        return new SetPropertyAccessor(configuration,indexOrKeyName);
    }
